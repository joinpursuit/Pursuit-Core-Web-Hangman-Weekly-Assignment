document.addEventListener('DOMContentLoaded', () => {
    ...
    let images = ["./2.png", "./3.png", "./4.png", "./5.png", "./6.png", "./7.png"];
    ...
    let thePic = document.querySelector("img");
    ...
    theButton.addEventListener("click", () => {
        ...
        console.log(userGuess)
            if (hangmanWord.includes(userGuess)) {
                ...
                // console.log(arr);
                let wordSplit = wordDash.split("");
                // console.log(wordSplit);
                if (userGuess === hangmanWord[i]) {
                    wordSplit[i] = userGuess;
                    wordDash = wordSplit.join("");
                    theWord.innerText = wordDash;     
                }
                }
            } else {
            ...
            guessed.innerText = guesses;
            input.value = ""
            left.innerText = `Guesses Left: ${limit}`;

            if (limit === 0) {
                    left.innerText = "YOU LOSE!"
                    thePic.src = "./8.png"
            ...
            if (hangmanWord === wordDash) {
            left.innerText = "YOU WIN!"
            input.style.display = "none";
            theButton.style.display = "none";
            button2.style.display = "block";
            }
